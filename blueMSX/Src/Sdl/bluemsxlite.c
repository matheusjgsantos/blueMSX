...
{   
    ...
    printf(stdout,"DEBUG - bluemsxlite.c machineSetDirectory as %s\n",buffer);
...
int main(int argc, char **argv)
{
    ...
    defaultDir = "/home/matheusjgsantos/Projects/MSX/BlueMSX/blueMSX_2.9.0/bluemsx-code/blueMSX/Make/blueMSXlite/linux-sdl";
    fprintf(stdout,"DEBUG - stasDefDir set as %s\n",defaultDir);
